...
import { decreamentQuantity, deleteItem, increamentQuantity, resetCart } from '../redux/StoreSlice'
    ...
    return (
        <div className='w-2/3 pr-10'>
                        ...
                        <div key={item._id} className="flex items-center justify-between gap-6 mt-6">
                            ...
                            <div className='w-52 flex items-center justify-between text-gray-500 gap-4 border p-3'>
                                ...
                                <div className="flex items-center gap-4 text-sm font-semibold">
                                    <span onClick={()=> dispatch(decreamentQuantity({
                                        _id: item._id,
                                        title: item.title,
                                        image: item.image,
                                        price: item.price,
            ...
            >
                ...
                <Link to="/">
                    <button className='mt-8 ml-7 flex items-center gap-1 text-gray-400 hover:text-black duration-300'><span>
                        <HiOutlineArrowLeft/>
